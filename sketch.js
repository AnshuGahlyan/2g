...
stay1 = createSprite(- 530, 0, 20, 50);
 ...
 plat13 = createSprite(3750,795,10,2000);
 plat13.shapeColor = "black";

 plat14 = createSprite(3900,700,10 ,2000);
 plat14.shapeColor = "black";
 plat15 = createSprite(3825,100,150,5);
 plat15.shapeColor = "green";
...
function draw() {
  ...
  if(z === 10){
    alert("After starting these, You are Proving Your Fake identity to them so Donot Lose |This is a test| ");
 
  }
  if(keyDown("up")&&player.x === 200){
    alert("Use arrow to move");
  }
...
console.log(player.x,player.y);
 ...
 if(player.x !== -512.15){
  ...
  if (player.isTouching(lavas)) {
    ...
    location.href = 'https://anshugahlyan.github.io/opss/index.html';
